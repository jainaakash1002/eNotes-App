        ...
        <>
            <div className="d-flex flex-Direction about">
                <div className="container aboutus width">
                    ...
                    <h6 className="footer">Made with&nbsp;<AiFillHeart size={25} color="red" title="MERN" />&nbsp;by&nbsp;<a href="https://aakashjain.netlify.app/" rel="noreferrer" target="_blank"><u>AAKASH JAIN</u></a><br />
